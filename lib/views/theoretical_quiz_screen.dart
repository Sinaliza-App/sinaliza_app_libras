...
class TheoreticalQuizScreen extends StatefulWidget {
  const TheoreticalQuizScreen({super.key});

  @override
  State<TheoreticalQuizScreen> createState() => _TheoreticalQuizScreenState();
}

class _TheoreticalQuizScreenState extends State<TheoreticalQuizScreen> with TickerProviderStateMixin {
  // --- Estado do Quiz ---
  ...
  Future<void> _finishQuiz() async {
    ...
    try {
      ...
      if (!mounted) return;
      Provider.of<UserProvider>(context, listen: false).addScore(_score);
    } catch (e) {
